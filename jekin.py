...
class Jenkins(object):
    ...
    def __init__(self, url, thread_num = 10, pwd_dic = "comm_dic.txt",login_dic = "comm_dic.txt"):
        self.url = url
...
if __name__ == '__main__':
    ...
    parser.add_option('-l', '--login', dest = 'login', type='string', default = 'comm_dic.txt', help = 'Dict file used to brute jenkins')
    ...
    jenkins_work = Jenkins(url = options.url, thread_num = options.thread_num, pwd_dic = options.dic,login_dic = options.login)
    jenkins_work.work()